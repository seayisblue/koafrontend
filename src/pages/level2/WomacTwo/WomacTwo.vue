...
const { womacData } = useWomacData(2, "two")
const { onTapBack, onTapNext } = usePageShared({ 
  prev_page_name: "womac-one", 
  title_key: "womac-two.title", 
  next_page_name: "womac-three",
})
