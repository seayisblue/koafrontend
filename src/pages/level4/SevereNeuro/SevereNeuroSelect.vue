...
onActivated(() => {
  liuUtil.setAppTitle({ val_key: "severe-neuro.select-title" })
})
...
<div class="page-wrapper">
  <div class="page-container">
    ...
    <div class="list-container">
      ...
      >
        <span>{{ t(`severe-neuro.exercise-${exercise.key}`) }}</span>
      </div>
    </div>
    ...
    <div class="footer-btns">
      ...
      <button class="action-btn btn-primary" @click="onTapNext">
        下一步
      </button>
    </div>
