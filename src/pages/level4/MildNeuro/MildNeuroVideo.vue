...
const exerciseVideoMap: Record<string, FileKey2> = {
  'knee-stretch-when-sitting': 'knee_stretch_when_sitting',
  'walk-up-and-down-the-stairs': 'walk_up_and_down_the_stairs',
  'walk-up-and-down-the-block': 'walk_up_and_down_the_block',
  'slide-forward-and-back-with-balancing-pad': 'slide_forward_and_back_with_balancing_pad',
  'advanced-stand-to-sit': 'advanced_stand_to_sit',
  'stand-on-one-leg-with-balancing-pad': 'stand_on_one_leg_with_balancing_pad',
  'stand-on-one-leg-against-wall': 'stand_on_one_leg_against_wall',
  'quadriceps-stretching': 'quadriceps_stretching',
}
...
watch(() => exerciseId.value, (newId) => {
  ...
  const titleKey = `mild-neuro.exercise-${newId}`
