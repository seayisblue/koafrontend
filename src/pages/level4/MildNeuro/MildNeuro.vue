...
onActivated(() => {
  liuUtil.setAppTitle({ val_key: "mild-neuro.title" });
});

const onTapStart = () => {
  rr.router.push({ name: 'mild-neuro-select' });
};
...
const pageData = {
  title: t("mild-neuro.title"),
  infoList: [
    { label: t("mild-neuro.frequency"), value: t("mild-neuro.frequency-value") },
    { label: t("mild-neuro.intensity"), value: t("mild-neuro.intensity-value") },
    { label: t("mild-neuro.duration"), value: t("mild-neuro.duration-value") },
  ],
  tipTitle: t("mild-neuro.tip-title"),
  tipContent: t("mild-neuro.tip-content"),
...
<div class="page-wrapper">
  <div class="page-container">
    ...
    <div class="illustration-box">
      <img :src="balanceImg" class="illustration-img" alt="Illustration" />
    </div>

    <div class="info-card">
      <div v-for="(item, index) in pageData.infoList" :key="index" class="info-row">
