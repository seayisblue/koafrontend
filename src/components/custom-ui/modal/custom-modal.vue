...
import LiuCheckbox from "../../common/liu-checkbox/liu-checkbox.vue";
...
<template>
  ...
  <div 
    v-if="modalEnable" 
    class="liu-no-select cui-modal-container" 
  ...
  >
    ...
    >
      ...
      <p v-if="modalData.content" 
         v-html="modalData.content"></p>
      ...
      <div class="cui-modal-btns">
        ...
        >
          ...
          <span v-else>{{ t('shared.cancel') }}</span>
        </div>
        <div 
        ...
        >
          ...
          <span v-else>{{ t('shared.confirm') }}</span>
        </div>
      </div>
    </div>
  </div>
